    ...
    <div className={styles.content}>
      ...
      <div className={styles.rightContent}>
        <div className={styles.mainNotice}>
          <div className={styles.bigImgContainer}><img src={'https://variety.com/wp-content/uploads/2016/07/suicide-squad-18.jpg'} alt="" /></div>
          <span className={styles.mainNoticeData}>
          <span>2 Hours Ago - by Yoga</span>
            <h3>'Suicide Squad' Is a Hit, But DC Needs to Start Making Better Movies</h3>
            <p>
            ...
            <button><h4>read full article</h4></button>
          </span>
        </div>
        ...
        <div className={styles.smallNoticesContainer}>
          ...
          <div className={styles.imgContainer}>
            <img src={'https://media.wired.com/photos/5926a12daf95806129f5018d/master.jpg'} alt="" />
          </div>
          ...
          <div className={styles.smallNotice}>
          <div className={styles.imgContainer}><img src={'https://media.npr.org/assets/img/2017/10/27/tra2016_comp_v005_008088.1111_wide-bc335cede10d086ba948db2d66f0093d36f0cc1e-s1100-c50.jpg'} alt="" /> </div>
            <div className={styles.smallNoticeData}>
          ...
          <div className={styles.smallNotice}>
           <div className={styles.imgContainer}>
             <img src={'https://www.giantfreakinrobot.com/wp-content/uploads/2021/05/Brie-Larson-Captain-Marvel-feature-900x506.jpg'} alt="" />
            </div>
            <div className={styles.smallNoticeData}>
              <span>2 hours ago - by Rob</span>
